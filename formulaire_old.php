...
<?php include("bdd/bdd.php"); ?>
    ...
    <body>
        ...
        <form class="profile_form" method="post" action="bdd/bdd.php">
            ...
            <input type="radio" name="environnement" value="ville"> Ville
            <br>
            <input type="radio" name="environnement" value="campagne"> Campagne
            <br>
            <input type="radio" name="environnement" value="montagne"> Montagne
            <br>
            <br>
            ...
            <br>
            <input type="radio" name="humeur" value="colere"> Colère
            <br>
            <br>
            <br>
